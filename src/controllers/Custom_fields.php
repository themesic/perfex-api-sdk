...
class Custom_fields extends REST_Controller {
    ...
    public function data_get($type = "", $id = "") {
        ...
        $fields = $this->custom_fields_model->get_custom_fields($type, [], false, $this->playground());
        $customfields = [];
        foreach ($fields as $key => $field) {
            ...
            $customfields[$key]->value = $this->custom_fields_model->get_custom_field_value($id, $field['id'], $type, false, $this->playground());
