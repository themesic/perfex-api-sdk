...
class Timesheets extends REST_Controller
{
    ...
    {
        $data = $this->tasks_model->get_timesheets($id, $this->playground());
    ...
    public function data_post()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $id = $this->tasks_model->timesheets($data, $this->playground());
    ...
    public function data_put($id = '')
    {
        ...
        if (empty($id) && !is_numeric($id)) {
            ...
            $data = $_POST;
            $output = $this->tasks_model->update_timesheet($data, $this->playground());
    ...
    public function data_delete($id = '')
    {
        ...
        if (empty($id) && !is_numeric($id)) {
            ...
            $output = $this->tasks_model->delete_timesheet($id, $this->playground());
